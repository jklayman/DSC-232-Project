...
- Tristan Roman: I worked with my team throughout all milestones. For milestone 1, I helped outline our plan of action and define meaningful datasets that we all are passionate about. With that, I helped write parts of our initial abstract. Later in milestone 2, I helped coordinate and implement pre-processing possabiltities as well as researched the best setup config given our large dataset, eventually supporting the transfer of our 50gb CSV to an Expanse storage spot. Once transferred, I rewrote the CSV to parquet. In milestone 3, I helped define our pipeline, allowing for an implementation of the TF-IDF model and its subsequent hyperparameter tests. Lastly, in milestone 4, I helped define our plan of action and supported implementing various parts of the final README, specifically future research and feature exploration graphs. Ultimately, I was blown away at the dedication and thouroughness of my fellow team members and couldn't have asked for a better team.
